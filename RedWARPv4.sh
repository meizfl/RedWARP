...
if grep -q "S1 = 0" RedWARP.conf && grep -q "MTU = 1420" RedWARP.conf && grep -q "Endpoint = engage.cloudflareclient.com:2408" RedWARP.conf && grep -q "DNS = 208.67.222.222, 208.67.220.220" RedWARP.conf; then
